         ...
         <div class="col-md-12 right-box">
          <div class="row align-items-center">
                ...
                <div class="input-group mb-3">
                    <input type="text" name="ism" class="form-control form-control-lg bg-light fs-6" required placeholder="Ism">
                </div>
                <div class="input-group mb-3">
                    <input type="text" name="familiya" class="form-control form-control-lg bg-light fs-6" required placeholder="Familiya">
                </div>
                <div class="input-group mb-3">
                    <input type="text" name="oquvchi_id" class="form-control form-control-lg bg-light fs-6" required placeholder="O'quvchi ID">
                </div>
                <div class="input-group mb-3">
                    <input type="text" name="e_mail" class="form-control form-control-lg bg-light fs-6" required placeholder="Email">
                </div>
                <div class="input-group mb-3">
                ...
                <div class="input-group mb-3">
                    <button style="background:linear-gradient(red, blue);padding:10px 25px;color:#fff;border:none;border-radius:10px;font-weight:bold;">Ro'yxatdan o'tish</button>
                </div>
               </form>
          </div>
       </div>
